...
public class LeerArchivo {
	...
	public ArrayList<ReglaVendedor> leerReglasVendedor() {
		ArrayList<ReglaVendedor> reglasDisponibles = new ArrayList<ReglaVendedor>();
		try {
	         // Apertura del fichero y creacion de BufferedReader 
			//para poder hacer una lectura comoda (disponer del metodo readLine()) 
	         archivo = new File ("src/reglasVendedor.txt");
	         fr = new FileReader (archivo);
	         br = new BufferedReader(fr);
	        ...
	        while((linea=br.readLine())!=null) {      	
	        	...
	        	ReglaVendedor nuevaRegla = new ReglaVendedor();
	        	ArrayList<String> condicion = new ArrayList<String>();
	        	int i=0;
	        	String palabra="";
	        	//cargo las condiciones 
	        	...
	        	int prioridad = Integer.valueOf(prioridadAux);
	        	i++;
	        	//cargo el tipo de producto
	        	String tipoProducto="";
	        	while(linea.charAt(i)!='*') {
	        		tipoProducto+=linea.charAt(i);
	        		i++;
	        	}
	        	i++;
	        	//cargo el tipo de pregunta
	        	...
	        	nuevaRegla.setTipoPregunta(tipo);
	        	nuevaRegla.setFiltrado(filtrado);
	        	nuevaRegla.setTipoProducto(tipoProducto);
	        	reglasDisponibles.add(nuevaRegla);
